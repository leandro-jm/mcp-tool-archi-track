...
const TOKEN = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsInJvbGVOYW1lIjoibWVtYmVyIiwiaWF0IjoxNzQyNTE5NDM1LCJleHAiOjE3NDUxMTE0MzV9.8EI70DvVAV3EVjslx2UQENGEtfDbs6_ezbCI6cCNpqc";
...
async function test(application) {
    async (application) => {
        ...
        const applicationData = await makeRequest(applicationUrl);
